...
from ImbalancedSSL.data_utils import get_data_loader
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.vanilla_opt:
        ...
        scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer,
                                                            milestones=[int(0.2 * args.num_train_iter),
                                                                        int(0.4 * args.num_train_iter),
                                                                        int(0.55 * args.num_train_iter),
                                                                        int(0.66 * args.num_train_iter)], gamma = 0.1)
    ...
    dset_dict = {'train_lb': lb, 'train_ulb': ulb, 'eval': eval}
    loader_dict = {}
    ...
    ## printing the size of the dataloaders
    print("train lb loader size:", len(loader_dict['train_lb']))
