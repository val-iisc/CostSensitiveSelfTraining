...
from .fixmatch_utils import consistency_loss, Get_Scalar, CSLSupNonDiag, CSL_consistency_loss
...
class FixMatch:
    def __init__(self, net_builder, num_classes, ema_m, T, p_cutoff, lambda_u,\
                 ...
                 tb_log=None, logger=None,classes =[]):
        """
    ...
    def validate(self, args):
        ...
        criterion = CSLSupNonDiag(M, D, device=device)
        return criterion
